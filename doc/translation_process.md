...
The Fatzchain Core GUI can be easily translated into other languages. Here's how we
...
https://www.transifex.com/projects/p/fatzchain/
...
2. update `src/qt/fatzchain.qrc` manually or via
