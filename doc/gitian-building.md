...
- [Building Fatzchain](#building-dash)
...
git clone https://github.com/evilfatone/dash.git
cd dash
...
```bash
    ...
    From https://github.com/evilfatone/dash
...
[dash/gitian.sigs](https://github.com/evilfatone/gitian.sigs/) repository, or if that's not possible to create a pull
request.
