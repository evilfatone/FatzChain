UNIX BUILD NOTES
====================
Some notes on how to build Fatzchain in Unix. 
...
memory available when compiling Fatzchain Core. With 512MB of memory or less
...
If you want to build Fatzchain-Qt, make sure that the required packages for Qt development
...
# Configure Fatzchain Core to use our own-built instance of BDB
cd $DASH_ROOT
...
Security
--------
To help make your Fatzchain installation more secure by making certain attacks impossible to
