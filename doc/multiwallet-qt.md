...
Only requiring some minor changes is fatzchain.cpp.
...
Changes to fatzchain.cpp
----------------------
fatzchain.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
