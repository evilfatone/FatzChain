...
QT_TRANSLATE_NOOP("dash-core", "Copyright (C) 2014-%i The Fatzchain Core Developers"),
...
QT_TRANSLATE_NOOP("dash-core", "Error loading wallet.dat: Wallet requires newer version of Fatzchain Core"),
...
QT_TRANSLATE_NOOP("dash-core", "Fee (in FATZCHAIN/kB) to add to transactions you send (default: %s)"),
...
QT_TRANSLATE_NOOP("dash-core", "Initialization sanity check failed. Fatzchain Core is shutting down."),
...
QT_TRANSLATE_NOOP("dash-core", "Keep N FATZCHAIN anonymized (default: %u)"),
...
QT_TRANSLATE_NOOP("dash-core", "Wallet needed to be rewritten: restart Fatzchain Core to complete"),
