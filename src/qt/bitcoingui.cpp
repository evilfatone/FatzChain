    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Fatzchain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Fatzchain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fatzchain: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Fatzchain Core"), this);
    aboutAction->setStatusTip(tr("Show information about Fatzchain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Fatzchain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Fatzchain addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Fatzchain addresses"));
    ...
    openAction->setStatusTip(tr("Open a fatzchain: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Fatzchain Core help message to get a list with possible Fatzchain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Fatzchain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Fatzchain network", "", count));
}
...
{
    QString strTitle = tr("Fatzchain Core"); // default title
