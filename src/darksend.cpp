...
/* *** BEGIN DARKSEND MAGIC - FATZCHAIN **********
    Copyright (c) 2014-2015, Fatzchain Developers
        eduffield - evan@evilfatone.io
        udjinm6   - udjinm6@evilfatone.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Fatzchain and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("fatzchain-darksend");
