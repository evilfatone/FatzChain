...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Fatzchain Core fatzchain-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  fatzchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fatzchain transaction") + "\n" +
              "  fatzchain-tx [options] -create [commands]   " + _("Create hex-encoded fatzchain transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fatzchain transaction
