...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 FATZCHAIN:
        ...
        # Node0's balance should be starting balance, plus 500 FATZCHAIN for another
        ...
        # Node0's total balance should be starting balance, plus 1000 FATZCHAIN for 
